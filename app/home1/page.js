...
.bringer-socials-list a {
  ...
  <div className="swiper-pagination bringer-dots" slot="pagination"></div>
          ...
          <section data-padding="none">
            <div
              className="bringer-grid-4cols bringer-tp-grid-2cols bringer-m-grid-2cols stg-m-small-gap"
              data-stagger-appear="zoom-in"
              data-stagger-pagehide="zoom-out"
            >
              ...
              <div className="bringer-counter bringer-block" data-delay="3000">
                <div className="bringer-counter-number" data-suffix="k+">30</div>
          ...
          </section>  <section data-padding="none">
            <div
              className="bringer-grid-4cols bringer-tp-grid-2cols bringer-m-grid-2cols stg-m-small-gap"
              data-stagger-appear="zoom-in"
              data-stagger-pagehide="zoom-out"
